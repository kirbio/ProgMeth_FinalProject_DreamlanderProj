...
public class RoundStartScreen extends Group {
	...
	// initially called once by constructor, then later called by GameLogic
	// every time after win the level
	public void update() {
		...
		gc.fillText("LEVEL " + (GameLogic.instance.getStageLevel() + 1), GameScreen.SCREEN_WIDTH / 2,
				GameScreen.SCREEN_HEIGHT / 5);
